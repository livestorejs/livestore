...
1. **Install dependencies**
   ...
   <Tabs syncKey="package-manager">
     <TabItem label="bun">
       ```shell
       bun add @livestore/livestore @livestore/wa-sqlite @livestore/adapter-web @livestore/react @livestore/utils @livestore/peer-deps @livestore/devtools-vite effect
       ```
     </TabItem>
     <TabItem label="pnpm">
       ```shell
       pnpm add @livestore/livestore @livestore/wa-sqlite @livestore/adapter-web @livestore/react @livestore/utils @livestore/peer-deps @livestore/devtools-vite effect
       ```
     </TabItem>
     <TabItem label="npm">
       ```shell
       npm install @livestore/livestore @livestore/wa-sqlite @livestore/adapter-web @livestore/react @livestore/utils @livestore/peer-deps @livestore/devtools-vite effect
       ```
     </TabItem>
   </Tabs>
