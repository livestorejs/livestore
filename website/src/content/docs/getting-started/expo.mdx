...
2.  **Install dependencies**
    ...
    It's strongly recommended to use `bun` or `pnpm` for the simplest and most reliable dependency setup (see [note on package management](/getting-started/package-management) for more details).
    ...
    `bun install`
                ...
                <TabItem label="npm">
                	...
                	```
                	npm install @effect/experimental @effect/opentelemetry @effect/platform @effect/platform-browser @opentelemetry/api effect
                	```
                ...
                <TabItem label="yarn">
                	...
                	```
                	yarn add @effect/experimental @effect/opentelemetry @effect/platform @effect/platform-browser @opentelemetry/api effect
                	```
                </TabItem>
...
1.  **Install dependencies**
    ...
    ```bash
    bunx expo install @livestore/devtools-expo @livestore/adapter-expo @livestore/livestore @livestore/react @livestore/utils effect expo-sqlite
    ```
