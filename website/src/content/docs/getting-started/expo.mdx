...
1.  Set up project via: `npx tiged --mode=git git@github.com:livestorejs/livestore/examples/standalone/expo-todomvc my-app`
...
If you need a custom build, you could run `bun expo run:ios` or `bun expo run:android` to build the app locally.
