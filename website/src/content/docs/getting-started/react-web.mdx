...
2. **Install dependencies**
   ...
   <Tabs syncKey="package-manager">
     ...
     <TabItem label="yarn">
       Given `yarn` doesn't automatically install peer dependencies you'll also need to install the following peer dependencies:
       ...
       Going forward you can use `yarn install` again to install the dependencies.
     </TabItem>
   </Tabs>
...
1. **Install dependencies**
   ...
   <Tabs syncKey="package-manager">
     <TabItem label="bun">`bun add @livestore/livestore @livestore/wa-sqlite @livestore/web @livestore/react @livestore/utils @livestore/devtools-vite effect`</TabItem>
     <TabItem label="pnpm">`pnpm add @livestore/livestore @livestore/wa-sqlite @livestore/web @livestore/react @livestore/utils @livestore/devtools-vite effect`</TabItem>
     <TabItem label="npm">`npm install @livestore/livestore @livestore/wa-sqlite @livestore/web @livestore/react @livestore/utils @livestore/devtools-vite effect`</TabItem>
     <TabItem label="yarn">`yarn add @livestore/livestore @livestore/wa-sqlite @livestore/web @livestore/react @livestore/utils @livestore/devtools-vite effect`</TabItem>
   </Tabs>
