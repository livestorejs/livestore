...
import { type Bindable, type PreparedBindValues, sql } from './utils/util.js'
...
export class InMemoryDatabase {
  ...
  constructor(
    ...
    this.cachedStmts.onEvict = (_queryStr, stmt) => stmt.finalizeSync()
  }
  ...
  getTablesUsed(query: string) {
    ...
    try {
      const res = stmt.executeSync<{ tbl_name: string }>([query])
