...
import { decrementInteger, generateKeyBetween, generateNKeysBetween, incrementInteger, midpoint } from './dgreensp.js'

describe('midpoint', () => {
  it('passes tests', () => {
    expect(midpoint('')).toBe('V')
    expect(midpoint('V')).toBe('l')
    expect(midpoint('l')).toBe('t')
    expect(midpoint('t')).toBe('x')
    expect(midpoint('x')).toBe('z')
    expect(midpoint('z')).toBe('zV')
    expect(midpoint('zV')).toBe('zl')
    expect(midpoint('zl')).toBe('zt')
    expect(midpoint('zt')).toBe('zx')
    expect(midpoint('zx')).toBe('zz')
    expect(midpoint('zz')).toBe('zzV')
...
describe('get order between', () => {
  it('passes tests', () => {
    ...
    expect(generateKeyBetween('a0')).toBe('a1')
    ...
    expect(generateKeyBetween('bzz')).toBe('c000')
    ...
    expect(generateKeyBetween(undefined, 'A000000000000000000000000001')).toBe('A000000000000000000000000000V')
    expect(generateKeyBetween('zzzzzzzzzzzzzzzzzzzzzzzzzzy')).toBe('zzzzzzzzzzzzzzzzzzzzzzzzzzz')
    expect(generateKeyBetween('zzzzzzzzzzzzzzzzzzzzzzzzzzz')).toBe('zzzzzzzzzzzzzzzzzzzzzzzzzzzV')
    expect(() => generateKeyBetween(undefined, 'A00000000000000000000000000')).toThrowError()
    expect(() => generateKeyBetween('a00')).toThrowError()
...
describe('generateNKeysBetween', () => {
  it('Gets the correct orders between', () => {
    ...
    expect(generateNKeysBetween('a4', undefined, 10).join(' ')).toBe('a5 a6 a7 a8 a9 aA aB aC aD aE')
...
describe('mixed usage', () => {
  it('works with midpoint and increment', () => {
    expect(incrementInteger(midpoint('a1', 'a2'))).toBe('a1W')
  })
})
