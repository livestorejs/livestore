...
// eslint-disable-next-line @typescript-eslint/no-unused-vars - If we ever extend user's custom worker RPC, type T can help here with expected return type safety. Currently unused.
