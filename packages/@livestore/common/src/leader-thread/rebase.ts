  ...
  Effect.andThen(
    ...
    (ctx) =>
      Effect.gen(function* () {
        ...
        // yield* syncProcessor.isOpen.close
        ...
        // Step 1:
        // const queueItems = yield* Queue.takeAll(syncProcessor.queue)
        ...
        // yield* syncProcessor.isOpen.open
      }),
    // .pipe(ctx.syncProcessor.semaphore.withPermits(1)),
  )
// .pipe(syncProcessorSemaphore.withPermits(1))
