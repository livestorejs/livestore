 ...
 */
export class WranglerDevServerError extends Schema.TaggedErrorClass<WranglerDevServerError>()('WranglerDevServerError', {
...
export class WranglerDevServerService extends Context.Service<WranglerDevServerService, WranglerDevServer>()(
  'WranglerDevServerService',
  {
    ...
    Effect.gen(function* () {
      ...
      const parsedConfig = yield* Effect.try({ try: () => Toml.parse(configContent), catch: (cause) => cause }).pipe(
