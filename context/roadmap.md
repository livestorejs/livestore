...
- **UI component kit.** Make much of the devtools UI available as a
  source-available reusable component kit (stated 2026-07-15). Will concern
  `02-system/07-devtools/` and contrib packaging when it becomes concrete.
