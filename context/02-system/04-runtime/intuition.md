...
Per client there is exactly one leader — the only context allowed to touch
the persisted eventlog, the persisted state database, and the upstream
...
the leader. This is the classic single-writer principle: concurrency
