...
import type { CmdError } from '@livestore/utils-dev/node'
...
export const prepareCi: Effect.Effect<void, PlatformError.PlatformError | CmdError, CommandExecutor.CommandExecutor> =
  Effect.gen(function* () {
