 ...
 */
const effectUtilsCatalogPatched = Object.assign(
  Object.create(Object.getPrototypeOf(effectUtilsCatalog)),
  {
    ...effectUtilsCatalog,
 ...
 */
export const pnpmWorkspaceTests = (
 ...
 * @param extraPackages - Additional non-@livestore workspace paths
 */
export const pnpmWorkspaceTestsReact = (
  packageNames: readonly string[],
  extraPackages?: readonly string[]
) =>
  pnpmWorkspaceYaml({
