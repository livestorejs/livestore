...
import atomsCode from '../../_assets/code/patterns/effect/store-setup/atoms.ts?snippet';
import queriesCode from '../../_assets/code/patterns/effect/store-setup/queries.ts?snippet';
import userListCode from '../../_assets/code/patterns/effect/store-setup/user-list.tsx?snippet';
import servicesCode from '../../_assets/code/patterns/effect/store-setup/services.tsx?snippet';
import optimisticCode from '../../_assets/code/patterns/effect/optimistic-example/optimistic.ts?snippet';
import derivedCode from '../../_assets/code/patterns/effect/derived-example/derived.ts?snippet';
import batchCode from '../../_assets/code/patterns/effect/batch-example/batch.ts?snippet';
...
<Code lang="ts" code={atomsCode} meta="twoslash" title="atoms.ts" />
...
<Code lang="ts" code={queriesCode} meta="twoslash" title="queries.ts" />
...
<Code lang="tsx" code={userListCode} meta="twoslash" title="UserList.tsx" />

### Integrating Effect Services

Combine Effect services with LiveStore operations using the store's runtime:

<Code lang="tsx" code={servicesCode} meta="twoslash" title="services.tsx" />
...
<Code lang="ts" code={optimisticCode} meta="twoslash" title="optimistic.ts" />

#### Derived State

Create computed atoms based on LiveStore queries. When using the non-unsafe API, handle the Result type:

<Code lang="ts" code={derivedCode} meta="twoslash" title="derived.ts" />

#### Batch Operations

Perform multiple commits efficiently (commits are synchronous):

<Code lang="ts" code={batchCode} meta="twoslash" title="batch.ts" />
