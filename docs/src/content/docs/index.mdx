...
<CardGrid>
  ...
  />
  <LinkCard title="Introduction" description="Introduction to LiveStore" href="/overview/introduction" />
  <LinkCard
    title="Evaluation"
  ...
  />
  <LinkCard title="Community" description="Community resources for LiveStore" href="/misc/community" />
  <LinkCard
    title="Contributing"
