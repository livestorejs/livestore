...
1. Client session commits an event
    ...
    <EventsVisualizer title='Client Session' events={["e1", "e2", "A:e3'{todoCreated}"]} />
    <EventsVisualizer title='Client Leader' events={["e1", "e2"]} />
    <EventsVisualizer title='Sync Backend' events={["e1", "e2"]} />
...
2. Client leader persists the event
    ...
    <EventsVisualizer title='Client Session' events={["e1", "e2", "A:e3'{todoCreated}"]} />
    <EventsVisualizer title='Client Leader' events={["e1", "e2", "A:e3'{todoCreated}"]} />
    <EventsVisualizer title='Sync Backend' events={["e1", "e2"]} />
...
4. Leader thread pushes the event to the backend
...
5. Sync backend pulls the event from the client leader
    ...
    <EventsVisualizer title='Client Session' events={["e1", "e2", "A:e3{todoCreated}"]} />
    <EventsVisualizer title='Client Leader' events={["e1", "e2", "A:e3{todoCreated}"]} />
    <EventsVisualizer title='Sync Backend' events={["e1", "e2", "A:e3{todoCreated}"]} />
...
1. Client session has local pending work while upstream advances
    ...
    <EventsVisualizer title='Client Session' events={["e1", "e2", "A:e3{todoRenamed}"]} />
    <EventsVisualizer title='Client Leader' events={["e1", "e2", "A:e3'{todoRenamed}"]} />
    <EventsVisualizer title='Sync Backend' events={["e1", "e2", "B:e3{todoRenamed}"]} />
...
2. Client leader pulls authoritative events from the sync backend
    ...
    <EventsVisualizer title='Client Session' events={["e1", "e2"]} />
    <EventsVisualizer title='Client Leader' events={["e1", "e2"]} />
    <EventsVisualizer title='Sync Backend' events={["e1", "e2", "B:e3{todoRenamed}"]} />
...
3. Client applies authoritative upstream events
    ...
    <EventsVisualizer title='Client Session' events={["e1", "e2", "B:e3{todoRenamed}"]} />
    <EventsVisualizer title='Client Leader' events={["e1", "e2", "B:e3{todoRenamed}"]} />
    <EventsVisualizer title='Sync Backend' events={["e1", "e2", "B:e3{todoRenamed}"]} />
...
4. Client replays its local pending events on top of the new head
    ...
    <EventsVisualizer title='Client Session' events={["e1", "e2", "B:e3{todoRenamed}", "A:e4{todoRenamed}/e3"]} />
    <EventsVisualizer title='Client Leader' events={["e1", "e2", "B:e3{todoRenamed}", "A:e4'{todoRenamed}/e3"]} />
    <EventsVisualizer title='Sync Backend' events={["e1", "e2", "B:e3{todoRenamed}"]} />
...
5. Client pushes its local pending events to sync backend
    ...
    <EventsVisualizer title='Client Session' events={["e1", "e2", "B:e3{todoRenamed}", "A:e4{todoRenamed}/e3"]} />
    <EventsVisualizer title='Client Leader' events={["e1", "e2", "B:e3{todoRenamed}", "A:e4{todoRenamed}/e3"]} />
    <EventsVisualizer title='Sync Backend' events={["e1", "e2", "B:e3{todoRenamed}", "A:e4{todoRenamed}/e3"]} />
