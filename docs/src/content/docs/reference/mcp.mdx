...
- `livestore_instance_connect`
  ...
  - Params example: `{ "storePath": "livestore-cli.config.ts", "storeId": "<store-id>" }`
  - Returns example:
...
- `livestore_sync_export`
  ...
  - Params example: `{ "storePath": "livestore-cli.config.ts", "storeId": "my-store" }`
...
- `livestore_sync_import`
  ...
  - Params example: `{ "storePath": "livestore-cli.config.ts", "storeId": "my-store", "data": { "version": 1, "storeId": "my-store", "events": [...] } }`
  - Params with options: `{ "storePath": "...", "storeId": "...", "data": {...}, "force": true, "dryRun": true }`
...
3. From your MCP client (e.g., Claude Desktop), call tools:
   ...
   - Connect: `livestore_instance_connect` with `{ "storePath": "livestore-cli.config.ts", "storeId": "<store-id>" }`
