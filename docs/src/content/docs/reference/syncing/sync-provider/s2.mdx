...
import clientSetupCode from '../../../../_assets/code/reference/syncing/s2/client-setup.ts?snippet';
import apiProxyImplementationCode from '../../../../_assets/code/reference/syncing/s2/api-proxy-implementation.ts?snippet';
...
export const CODE = {
  ...
  apiProxyImplementation: apiProxyImplementationCode,
...
<Code lang="ts" meta="twoslash" code={CODE.clientSetup} title="src/livestore.worker.ts" />
...
<Code lang="ts" meta="twoslash" code={CODE.apiProxyImplementation} title="api/s2.ts" />
