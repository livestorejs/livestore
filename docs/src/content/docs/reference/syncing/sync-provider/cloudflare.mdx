...
<MultiCode code={workerMinimal} />

<MultiCode code={workerMakeWorker} />
...
<MultiCode code={workerHandleSync} />
...
<MultiCode code={basicWsClient} />

### Custom Worker with Authentication

<MultiCode code={workerAuth} />

### Multi-Transport Setup

<MultiCode code={multiTransport} />
