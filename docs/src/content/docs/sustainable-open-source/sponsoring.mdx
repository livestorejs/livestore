...
- Sponsors receive exclusive benefits, including access to sponsor-only resources and maintainer time.
- LiveStore is source-available and community-supported—your sponsorship directly enables its ongoing development.
...
- Become a [contributor / maintainer](/sustainable-open-source/contributing/info)
