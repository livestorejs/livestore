...
NOTE: LiveStore DevTools are currently a [sponsor-only benefit](/sustainable-open-source/sponsoring).
...
1. **Unpack the ZIP file** (e.g. `livestore-devtools-chrome-<version>.zip`) into a folder on your computer.
