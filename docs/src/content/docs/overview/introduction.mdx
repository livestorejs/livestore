...
<div class="rounded-xl border border-gray-700 p-5">
  ...
  <ul class="!space-y-2 text-sm list-none p-0 m-0">
    <li>
      <strong>Principled</strong>: Event-driven instead of mutable state
    </li>
    <li>
      <strong>Composable & Type-safe</strong>: Fully typed events & queries
    </li>
    <li>
      <strong>Reactive</strong>: Automatic UI updates when data changes
    </li>
  </ul>
</div>
...
<details>
  <summary>Are you an expert? See here for advanced topics.</summary>- [How LiveStore deals with merge
  conflicts?](/overview/how-livestore-works#conflict-resolution) - Why event-sourcing instead of CRDTs or query-driven
  sync? - How do schema migrations work? - What are limitations of LiveStore? - How LiveStore is perfect for coding
  agents.
</details>
