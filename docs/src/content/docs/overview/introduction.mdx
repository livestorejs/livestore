...
- AX
  - Immutable eventlog enables testing and tight feedback loops
  - Deterministic state replay—same events always produce same state
  - State can be reset/forked for experimentation -->
