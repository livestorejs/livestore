...
We aim to meet every other Thursday at 18:00 Europe/Berlin. Check the
[LiveStore events calendar](https://lu.ma/livestore) for the confirmed next
meeting, registration, and joining details. The time stays at 18:00 in Berlin
when daylight saving time changes.

The [video meeting room](https://livestore.dev/meet) is on Riverside.

Recordings from previous contributor syncs:

<iframe
  width="560"
  height="315"
  src="https://www.youtube.com/embed/X4ihAzyj5TQ"
  title="YouTube video player"
  frameborder="0"
  allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture"
  allowfullscreen
