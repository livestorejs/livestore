...
We meet every two weeks, normally on Thursday at 19:00 Europe/Berlin.
See the [Contributor Sync page](/misc/contributor-sync/) for the next two meetings,
schedule changes, calendar subscriptions, and the Riverside meeting room.
