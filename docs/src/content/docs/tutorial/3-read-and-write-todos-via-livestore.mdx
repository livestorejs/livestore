...
<Tabs syncKey="package-manager">
  ...
  <TabItem label="bun">
    ...
    <Code code={`bun add  \\
    @livestore/livestore@0.4.0-dev.25 \\
    @livestore/wa-sqlite@0.4.0-dev.25 \\
    @livestore/adapter-web@0.4.0-dev.25 \\
    @livestore/react@0.4.0-dev.25 \\
    @livestore/peer-deps@0.4.0-dev.25`} lang="sh" />
...
- `@livestore/livestore@0.4.0-dev.25` → Implements the core LiveStore functionality (schema, events, queries, ...).
- `@livestore/wa-sqlite@0.4.0-dev.25` → Implements usage of a [SQLite build in WebAssembly](https://github.com/livestorejs/wa-sqlite), so you can use SQLite inside your browser.
- `@livestore/adapter-web@0.4.0-dev.25` → Implements the [LiveStore web adapter.](/platform-adapters/web-adapter)
- `@livestore/react@0.4.0-dev.25` → Provides [LiveStore integration for React](https://github.com/livestorejs/wa-sqlite).
- `@livestore/peer-deps@0.4.0-dev.25` → Required to [satisfy LiveStore peer dependencies](https://dev.docs.livestore.dev/misc/package-management/#peer-dependencies).
...
<Tabs syncKey="package-manager">
  ...
  <TabItem label="bun">
    ...
    <Code code={`bun add @livestore/devtools-vite@0.4.0-dev.25`} lang="sh" />

  </TabItem>

  <TabItem label="pnpm">

    <Code code={`pnpm add @livestore/devtools-vite@0.4.0-dev.25`} lang="sh" />
