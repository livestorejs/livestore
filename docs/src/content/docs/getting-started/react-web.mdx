...
import schemaCode from '../../../../../examples/web-todomvc-sync-cf/src/livestore/schema.ts?snippet'
import workerCode from '../../_assets/code/getting-started/react-web/livestore.worker.ts?snippet'
import rootCode from '../../_assets/code/getting-started/react-web/Root.tsx?snippet'
import headerCode from '../../_assets/code/getting-started/react-web/Header.tsx?snippet'
import mainSectionCode from '../../_assets/code/getting-started/react-web/MainSection.tsx?snippet'
...
<Code lang="ts" meta="twoslash" code={CODE.schema} title="src/livestore/schema.ts" />
...
<Code lang="ts" meta="twoslash" code={CODE.worker} title="src/livestore.worker.ts" />
...
<Code code={CODE.header} lang="tsx" meta="twoslash" title="src/components/Header.tsx" />
...
<Code code={CODE.mainSection} lang="tsx" meta="twoslash" title="src/components/MainSection.tsx" />
