...
import schemaCode from '../../_assets/code/getting-started/vue/livestore/schema.ts?snippet'
import workerCode from '../../_assets/code/getting-started/vue/livestore/livestore.worker.ts?snippet'
...
<Code code={CODE.worker} lang="ts" meta="twoslash" title="src/livestore/livestore.worker.ts" />
