...
import HeaderSnippet from '../../_assets/code/getting-started/expo/components/NewTodo.tsx?snippet'
import MainSectionSnippet from '../../_assets/code/getting-started/expo/components/ListTodos.tsx?snippet'
