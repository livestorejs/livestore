...
import { cloudflareExamples, getExampleDemoLinks } from '../../../data/examples.ts';
...
{cloudflareExamples.map((example) => {
  const { primaryUrl, secondaryUrl, primaryLabel, secondaryLabel } = getExampleDemoLinks(example);
  ...
  return (
    ...
    <div style="margin-top: auto; padding-top: 1rem;">
      {primaryUrl && (
        <p style="margin: 0 0 0.5rem 0;"><a href={primaryUrl} target="_blank" rel="noopener noreferrer">{primaryLabel}</a></p>
      )}
      {secondaryUrl && (
        <p style="margin: 0 0 0.5rem 0;"><a href={secondaryUrl} target="_blank" rel="noopener noreferrer">{secondaryLabel}</a></p>
      )}
