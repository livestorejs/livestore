...
export const Sponsor: React.FC = () => {
  return (
    <a
      ...
      className="flex items-center no-underline !mt-8 gap-2 px-4 py-2 text-sm font-semibold !text-white bg-orange-500 hover:bg-orange-600 rounded-lg transition-colors duration-200 w-fit"
    >
