 ...
 * Mailbox store maintains a synchronized projection for cross-thread filtering.
 * Use Mailbox store's threadLabels for browsing/filtering, Thread's for detail view.
 */
