...
const Editor = ({
  ...
  const editor = useEditor({
    ...
    editorProps: {
      attributes: {
        class: `prose text-gray-600 prose-sm prose-strong:text-gray-600 prose-p:my-2 prose-ol:my-2 prose-ul:my-2 prose-pre:my-2 w-full max-w-xl font-normal focus:outline-none appearance-none editor ${className}`,
      },
    },
