...
const OrderDirection = Schema.Literal('asc', 'desc').annotate({ title: 'OrderDirection' })
export type OrderDirection = typeof OrderDirection.Type

const OrderBy = Schema.Literal('priority', 'status', 'created', 'modified').annotate({ title: 'OrderBy' })
